...
public class PersonRepositoryImpl extends AbstractRepository<Person>
    implements ModelRepository<Person> {

  /**
   * Instantiates a new person repository impl.
   *
   * @throws PersistenceException the persistence exception
   */
  public PersonRepositoryImpl() throws PersistenceException {
    super(TestTables.Person);
  }
}
