...
/**
 * Interface to an entity populator, which populates entities from a result set.
 * 
...
public interface EntityPopulator {
   ...
   */
  void populate(Object entity, ResultSet resultSet) throws PersistenceException;
}
